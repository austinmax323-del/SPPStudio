...
echo "  - SPPStudioDocs/70_SessionContinuity/Sprints/current-sprint.md for current focus"
echo "  - SPPStudioDocs/70_SessionContinuity/ImplementationLog/active-implementation.md for active notes"
echo "  - SPPStudioDocs/50_RuntimeOps/Regressions/regression-tracker.md for regressions"
